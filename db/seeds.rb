...
puts "Criando moldes..."
moldes = [
  { codigo: "M001-2023", descricao: "Molde para painel frontal", cliente: clientes_criados[0], tipo: "injecao", status: "ativo", data_criacao: "2023-01-15", data_ultima_modificacao: "2023-05-20", responsavel: "roberto-almeida", observacoes: "Molde de alta precisão para componentes automotivos" },
  { codigo: "M002-2023", descricao: "Molde para carcaça de motor", cliente: clientes_criados[0], tipo: "pressao", status: "ativo", data_criacao: "2023-02-10", data_ultima_modificacao: "2023-06-15", responsavel: "roberto-almeida", observacoes: "Resistente a altas temperaturas" },
  { codigo: "M003-2023", descricao: "Molde para embalagens plásticas", cliente: clientes_criados[1], tipo: "injecao", status: "em-manutencao", data_criacao: "2023-03-05", data_ultima_modificacao: "2023-07-12", responsavel: "juliana-martins", observacoes: "Molde com múltiplas cavidades" },
  ...
  { codigo: "M005-2023", descricao: "Molde para componentes hidráulicos", cliente: clientes_criados[3], tipo: "fundicao", status: "inativo", data_criacao: "2023-05-18", data_ultima_modificacao: "2023-09-25", responsavel: "mariana-sousa", observacoes: "Liga especial de alumínio" },
  { codigo: "M006-2023", descricao: "Molde para peças de conexão", cliente: clientes_criados[4], tipo: "injecao", status: "ativo", data_criacao: "2023-06-22", data_ultima_modificacao: "2023-10-15", responsavel: "ricardo-pereira", observacoes: "Alta durabilidade para produção contínua" },
  { codigo: "M007-2023", descricao: "Molde para tampas industriais", cliente: clientes_criados[1], tipo: "compressao", status: "em-desenvolvimento", data_criacao: "2023-07-10", data_ultima_modificacao: "2023-11-05", responsavel: "juliana-martins", observacoes: "Projeto com design inovador" },
  ...
  { codigo: "M009-2023", descricao: "Molde para acessórios automotivos", cliente: clientes_criados[0], tipo: "injecao", status: "em-teste", data_criacao: "2023-09-20", data_ultima_modificacao: "2024-01-15", responsavel: "roberto-almeida", observacoes: "Compatível com novos modelos de veículos" },
  { codigo: "M010-2023", descricao: "Molde para componentes eletrônicos", cliente: clientes_criados[3], tipo: "precisao", status: "ativo", data_criacao: "2023-10-25", data_ultima_modificacao: "2024-02-20", responsavel: "mariana-sousa", observacoes: "Molde com sistema de refrigeração integrado" }
]
